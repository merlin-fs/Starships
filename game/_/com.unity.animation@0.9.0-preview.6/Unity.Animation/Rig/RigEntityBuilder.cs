...
namespace Unity.Animation
{
    ...
    {
        [GenerateTestsForBurstCompatibility(GenericTypeArguments = new[] { typeof(BurstCompatibleTransformHandle) })]
        ...
        public static readonly ComponentTypeSet RigComponentTypes = new ComponentTypeSet(
            typeof(Rig),
        ...
        public static readonly ComponentTypeSet RigPrefabComponentTypes = new ComponentTypeSet(
            typeof(Rig),
            typeof(SharedRigHash),
            typeof(AnimatedData),
            typeof(AnimatedLocalToWorld),
        ...
        private static void InitializeComponentsData(Entity entity, EntityManager entityManager, BlobAssetReference<RigDefinition> rigDefinition)
        {
            ...
            entityManager.SetSharedComponentManaged(entity, new SharedRigHash { Value = rigDefinition.Value.GetHashCode() });
