...
namespace Unity.Animation
{
    ...
    public static class BoneRendererEntityBuilder
    {
        ...
        static readonly ComponentTypeSet s_BoneMatrixComponentTypes = new ComponentTypeSet(
            typeof(RigEntity),
        ...
        static readonly ComponentTypeSet s_BoneRenderingComponentTypes = new ComponentTypeSet(
        ...
        )
        {
            ...
            entityManager.SetSharedComponentManaged(boneRenderEntity, new BoneRenderer.BoneShape { Value = properties.BoneShape });
