...
namespace Unity.Animation
{
        ...
        where TAnimatedRootMotion : struct, IAnimatedRootMotion
    {
        ...
        [ReadOnly] public ComponentLookup<Translation>     EntityTranslation;
        [ReadOnly] public ComponentLookup<Rotation>        EntityRotation;
        [ReadOnly] public ComponentLookup<Scale>           EntityScale;
        [ReadOnly] public ComponentLookup<NonUniformScale> EntityNonUniformScale;
        ...
        where TAnimatedRootMotion : struct, IAnimatedRootMotion
    {
        ...
        [NativeDisableContainerSafetyRestriction]
        public ComponentLookup<LocalToWorld>    EntityLocalToWorld;
        [NativeDisableContainerSafetyRestriction]
        public ComponentLookup<LocalToParent>   EntityLocalToParent;
        [NativeDisableContainerSafetyRestriction]
        public ComponentLookup<Translation>     EntityTranslation;
        [NativeDisableContainerSafetyRestriction]
        public ComponentLookup<Rotation>        EntityRotation;
        [NativeDisableContainerSafetyRestriction]
        public ComponentLookup<Scale>           EntityScale;
        [NativeDisableContainerSafetyRestriction]
        public ComponentLookup<NonUniformScale> EntityNonUniformScale;
        ...
        static TValue SelectAndSetEntityComponentData<TValue>(Entity entity, ComponentLookup<TValue> EntityData, TValue value, bool channelMask)
