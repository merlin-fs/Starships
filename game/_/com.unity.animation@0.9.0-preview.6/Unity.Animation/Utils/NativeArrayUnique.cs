...
namespace Unity.Collections
{
    ...
    {
        [Unity.Collections.GenerateTestsForBurstCompatibility(GenericTypeArguments = new[] { typeof(int) })]
        ...
        [Unity.Collections.GenerateTestsForBurstCompatibility(GenericTypeArguments = new[] { typeof(int), typeof(DefaultComparer<int>) })]
