...
namespace Unity.Entities
{
    ...
    public unsafe partial class World : IDisposable
    {
        ...
        /// </summary>
        public static event Action<World, ComponentSystemBase> SystemCreated;
        public static event Action<World, IntPtr, Type> UnmanagedSystemCreated;

        public static void DoUnmanagedSystemCreated(World world, void* ptr, Type type) =>
            UnmanagedSystemCreated?.Invoke(world, new IntPtr(ptr), type); 
